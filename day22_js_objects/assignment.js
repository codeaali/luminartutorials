// 1. temperature
// 2. todos
        //list all completed todos by user 1
        //numb of pending todos of user1
        //number of todos compltd by user 2
      ...
      //find dist with high temp : tsr

      temp.sort((a, b) => (a.temprature > b.temprature) ? -1 : 1)
...
var todouser = [
  ...
  // }
  // console.log("number of todos pending by user1: ",counter);
  // console.log("number of todos completed by user2: ",count2);
